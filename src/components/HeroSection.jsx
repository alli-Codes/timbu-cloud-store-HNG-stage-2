...
export default function HeroSection() {
  return (
    <div className="bg-[#E6C3A2] h-[80vh] lg:h-auto px-8 flex flex-col lg:flex-row items-start lg:items-center justify-center gap-32 lg:justify-end relative rounded-xl">
