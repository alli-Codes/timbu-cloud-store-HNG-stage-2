...
export default function Menu() {
  ...
  return (
    <div className="bg-[#FFFFFF] w-full flex justify-center fixed left-0 bottom-0 lg:hidden z-20">
      <div className={"w-full max-w-[30rem] px-8 py-5 flex justify-between"}>
        <Link to="/">
        ...
        <Link to="/savedproducts">
          <HeartIcon
            color={
              location.pathname == "/savedproducts" ? "#C31162" : "#292D32"
            }
          />
        </Link>
      </div>
